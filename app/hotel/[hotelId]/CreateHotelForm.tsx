...
function CreateHotelForm({ hotel }: { hotel?: hotelPropsType }) {
  ...
  return (
    <>
      <form
        className="flex flex-col lg:flex-row gap-20 w-full"
      ...
      >
        <section className="flex-1 flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="flex justify-between  pt-4 px-4 flex-col md:flex-row gap-5">
          ...
          <div className="flex-col flex ">
            <div>
              ...
              >
                <span className="px-4 py-2 rounded-md bg-zinc-800 hover:bg-zinc-950 text-slate-50">
                  Upload a file
                </span>
                <input
                  type="file"
        ...
        <section className="flex-1 flex flex-col gap-8">
          ...
          <div>
            <div className="flex-col flex ">
              ...
              />
              {!!messagesError.locationDescription && (
                <p className="text-red-500 text-[12px] font-bold pl-2">
                  {messagesError.locationDescription}
                </p>
              )}
          ...
          <div className="flex justify-between items-center">
            {hotel && (
              <>
                ...
                <button
                  ...
                  disabled={loading}
                  onClick={() =>
                    router.push("/hotel/hotel-details/" + hotel.id)
                  }
                >
            ...
            <button
              className={`flex gap-2 items-center w-fit px-3 py-2 rounded-md text-sm font-semibold bg-zinc-800 hover:bg-zinc-950 transition-colors text-slate-50 ${
                loading && "cursor-not-allowed"
              }`}
              disabled={loading}
            >
      ...
      {hotel && (
        <>
          <h3 className="text-xl font-bold mb-6">Hotel rooms</h3>
